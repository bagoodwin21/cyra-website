...
// Table contents are maintained in src/content/site-content.ts (content.compare.table).
const PLATFORMS: string[] = [...content.compare.table.platforms];
const ROWS: Row[] = content.compare.table.rows as unknown as Row[];
  ...
  return (
    <div>
      ...
      <p className="mt-4 text-small text-foreground-muted">
        {content.compare.comparison.footnote}
      </p>
    </div>
  );
}
